    ...
    public void accept(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        ...
        consumer.accept(KitchenLootTables.MINERSDELIGHT_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .setBonusRolls(ConstantValue.exactly(1.0F))
                        .when(ModCheckCondition.mod().isLoaded("miners_delight"))
                        .add(LootItem.lootTableItem(MDItems.VEGETABLE_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.PUMPKIN_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.HOT_COCOA_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.FISH_STEW_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.CHICKEN_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BEEF_STEW_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.NOODLE_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BAKED_COD_STEW_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.RABBIT_STEW_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.MUSHROOM_STEW_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BEETROOT_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BOWL_OF_STUFFED_SQUID.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.CAVE_SOUP_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.PASTA_WITH_VEGGIEBALLS.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.MILK_CUP.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.IMPROVISED_BARBECUE_STICK.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BAKED_TENTACLES.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.TENTACLES.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BAKED_SQUID.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.GLOW_SQUID.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.SQUID.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.WEIRD_CAVIAR.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.SILVERFISH_EGGS.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.SMOKED_BAT_WING.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BAKED_CAVE_CARROT.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.CAVE_CARROT.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(MDItems.BAT_WING.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                )
        );
        ...
        consumer.accept(KitchenLootTables.AETHER_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .when(IN_AETHER.or(STAGE_AETHER))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.CANDY_CANE.get()).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(AetherItems.GINGERBREAD_MAN.get()).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                )
        );
        ...
        consumer.accept(KitchenLootTables.FESTIVEDELIGHT_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(FestiveDelightModItems.FESTIVE_CHIKEN.get())
                                .when(NEW_YEAR_EVENT.or(CHRISTMAS_EVENT).or(EASTER_EVENT))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.CHRISTMAS_TEA.get()).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.GINGERBREAD_MAN.get()).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        ...
                        .add(LootItem.lootTableItem(FestiveDelightModItems.GINGERBREAD_COOKIE_SWORD.get())
                                .when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.SUGAR_CANE.get()).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.SALMON_VERRINES.get()).when(NEW_YEAR_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.LONGEVITY_NOODLE.get()).when(NEW_YEAR_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.SPRING_ROLLS.get()).when(NEW_YEAR_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(FestiveDelightModItems.SUS_BREAD.get()).when(HALLOWEEN_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                )
        );
        ...
        consumer.accept(KitchenLootTables.SNOWYSPIRIT_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(CANDY_CANE.get()).setWeight(10).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(GINGERBREAD_COOKIE.get()).setWeight(10).when(CHRISTMAS_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
        ...
        consumer.accept(KitchenLootTables.HAUNTEDHARVEST_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(CANDY_CORN.get()).setWeight(10).when(HALLOWEEN_EVENT)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
        ...
        consumer.accept(KitchenLootTables.FARMERSDELIGHT_EDIBLES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(ModItems.HOT_COCOA.get()).setWeight(10).when(WINTER))
                        .add(LootItem.lootTableItem(ModItems.APPLE_CIDER.get()).setWeight(10).when(AUTUMN))
                        .add(LootItem.lootTableItem(ModItems.MELON_JUICE.get()).setWeight(10).when(SUMMER))
                        ...
                        .add(LootItem.lootTableItem(ModItems.GRILLED_SALMON.get()).setWeight(10)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
                        .add(LootItem.lootTableItem(ModItems.ROAST_CHICKEN.get()).setWeight(10).when(AUTUMN))
                        .add(LootItem.lootTableItem(ModItems.STUFFED_PUMPKIN.get()).setWeight(10).when(AUTUMN))
                        .add(LootItem.lootTableItem(ModItems.HONEY_GLAZED_HAM.get()).setWeight(10).when(EASTER_EVENT))
                        .add(LootItem.lootTableItem(ModItems.SHEPHERDS_PIE.get()).setWeight(10).when(SPRING))
                )
        );
