        ...
        consumer.accept(DimDungeonLootTables.KIT_RANDOM, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootTableReference.lootTableReference(DimDungeonLootTables.KIT_BLACKSTONE)
                                .when(IN_NETHER.or(IN_DUNGEON).or(STAGE_NETHER)))
                        ...
                        .add(LootTableReference.lootTableReference(DimDungeonLootTables.KIT_END_STONES)
                                .when(IN_END.or(STAGE_END).or(IN_DUNGEON)))
        ...
        consumer.accept(DimDungeonLootTables.KIT_FOOD, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootTableReference.lootTableReference(KitchenLootTables.SUPPLEMENTARIES_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.ENDSDELIGHT_EDIBLES).when(IN_END.or(STAGE_END))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.PHANTASM_EDIBLES).when(IN_END.or(STAGE_END))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.UNUSUALEND_EDIBLES).when(IN_END.or(STAGE_END))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        ...
                        .add(LootTableReference.lootTableReference(KitchenLootTables.AETHER_EDIBLES).when(IN_AETHER.or(STAGE_AETHER))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.NETHERSSDELIGHT_EDIBLES).when(IN_NETHER.or(STAGE_NETHER))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                )
        );
        ...
        consumer.accept(DimDungeonLootTables.KIT_INGOTS, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(15)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootItem.lootTableItem(QUARTZ_ENRICHED_IRON.get()).setWeight(5).when(IN_NETHER.or(STAGE_NETHER))
        ...
        consumer.accept(DimDungeonLootTables.KIT_BRICK_SET, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Blocks.MUD_BRICKS)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootItem.lootTableItem(Blocks.NETHER_BRICKS).when(IN_NETHER.or(STAGE_NETHER).or(IN_DUNGEON))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootItem.lootTableItem(Blocks.RED_NETHER_BRICKS).when(IN_NETHER.or(STAGE_NETHER).or(IN_DUNGEON))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootItem.lootTableItem(Blocks.SHROOMLIGHT).when(IN_NETHER.or(STAGE_NETHER).or(IN_DUNGEON))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
        ...
        consumer.accept(DimDungeonLootTables.KIT_MISC, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.SLIME_BALL)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootItem.lootTableItem(SILICON.get()).when(IN_NETHER.or(STAGE_NETHER))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
