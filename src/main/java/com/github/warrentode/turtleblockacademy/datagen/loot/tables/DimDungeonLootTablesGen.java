...
public class DimDungeonLootTablesGen implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    public void accept(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        ...
        consumer.accept(DimDungeonLootTables.KIT_FOOD, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootTableReference.lootTableReference(KitchenLootTables.SUPPLEMENTARIES_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.ENDSDELIGHT_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.PHANTASM_EDIBLES))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9)))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.UNUSUALEND_EDIBLES))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9)))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.ECOLOGICS_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.AETHER_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9))))
                        .add(LootTableReference.lootTableReference(KitchenLootTables.NETHERSSDELIGHT_EDIBLES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(5, 9)))
                )
        ));
        ...
        consumer.accept(DimDungeonLootTables.KIT_INGOTS, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.NETHERITE_INGOT).setWeight(1))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5)))
                        .add(TagEntry.expandTag(TBATags.Items.ENDONIAN_INGOT).setWeight(10))
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5)))
                )
        );
        ...
        consumer.accept(DimDungeonLootTables.KIT_BASIC_SUPPLIES, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .name("dimdungeons:kit_basic_supplies")
                        .setRolls(ConstantValue.exactly(27))
