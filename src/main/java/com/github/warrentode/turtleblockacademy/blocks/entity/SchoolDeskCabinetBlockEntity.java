...
public class SchoolDeskCabinetBlockEntity extends RandomizableContainerBlockEntity {
    private NonNullList<ItemStack> contents = NonNullList.withSize(27, ItemStack.EMPTY);

    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        protected void onOpen(@NotNull Level level, @NotNull BlockPos pos, @NotNull BlockState state) {
            SchoolDeskCabinetBlockEntity.this.playSound(state, ModSounds.BLOCK_DESK_OPEN.get());
            SchoolDeskCabinetBlockEntity.this.updateBlockState(state, true);
        }

        protected void onClose(@NotNull Level level, @NotNull BlockPos pos, @NotNull BlockState state) {
            SchoolDeskCabinetBlockEntity.this.playSound(state, ModSounds.BLOCK_DESK_CLOSE.get());
            SchoolDeskCabinetBlockEntity.this.updateBlockState(state, false);
        }
        ...
        protected boolean isOwnContainer(@NotNull Player player) {
            if (player.containerMenu instanceof ChestMenu) {
                ...
                return container == SchoolDeskCabinetBlockEntity.this;
            }
            else {
                return false;
            }
    ...
    public SchoolDeskCabinetBlockEntity(BlockPos pos, BlockState state) {
    ...
    protected @NotNull Component getDefaultName() {
        return Component.translatable("container.turtleblockacademy.desk_cabinet");
    }
